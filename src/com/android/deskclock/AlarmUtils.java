...
public class AlarmUtils {
    ...
    public static String getFormattedTime(Context context, Calendar time) {
       ...
       // return (String) DateFormat.format(pattern, time);
        ...
        int shiFen[] = new int[] {R.string.shan_wu,R.string.zhong_wu,R.string.shyia_wu,
        ...
        int ampm = 0;
		String str_week = context.getResources().getString(weeks[day-1]);

        if (DateFormat.is24HourFormat(context)) {
			
			return (str_week+" "+(hour<10 ?"0" + hour: ""+hour)+":"+(minute<10 ?"0" + minute: ""+minute));
		} else {
			...
			String str_ampm = context.getResources().getString(ampm);
			return (str_week+" "+str_ampm+(hour<10 ?"0" + hour: ""+hour)+":"+(minute<10 ?"0" + minute: ""+minute));
		}

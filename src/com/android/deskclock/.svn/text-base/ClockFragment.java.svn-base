...
public class ClockFragment extends DeskClockFragment implements OnSharedPreferenceChangeListener {
  ...
  /*  
    ...
    private int Count = 0;
    */
    private TestSettingAlarm testSettingAlarm;
    
    public interface TestSettingAlarm{
    	
    	void setTestSettingAlarm();
    }
    
    public void setInterfaceTestSettingAlarm(TestSettingAlarm testSettingAlarm){
    	this.testSettingAlarm = testSettingAlarm;
    }
    ...
    private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (changed) {
                ...
                Utils.updateDate(getActivity(),mDateFormat, mDateFormatForAccessibility,mClockFrame);
                if (mAdapter != null) {
                    ...
                    if (action.equals(Intent.ACTION_LOCALE_CHANGED)) {
                        if (mDigitalClock != null) {
                            ...
                            ((TextClock)(mDigitalClock.findViewById(R.id.digital_clock))).setTypeface(getFont.getLcdFonttype());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getFont = new GetFont(getActivity());
  ...
  /*      
        button_exit = (Button)v.findViewById(R.id.button_exit_new);
        ...
        button_fullScreen = (Button)v.findViewById(R.id.button_fullScreen_new);
        ...
        button_setting = (Button)v.findViewById(R.id.button_setting_new);
    ...
    public void onResume () {
     ...
     /*   MySharedPreferences mySharedPreferences = new MySharedPreferences(getActivity());
        if(mySharedPreferences.getAlarmInstance() == 0 && testSettingAlarm != null)
        	testSettingAlarm.setTestSettingAlarm();*/
    }

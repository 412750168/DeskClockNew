...
public class AlarmDialogNew {
	...
	public AlarmDialogNew(Context context) {
		super();
	...
	private void caculaterAlarmLeftTime(){
		...
		int tempTime = hour_count *60 + minute_count;
        ...
        if(tempDaysofWeek == currentDaysofWeek){
        	...
        	if(tempTime > currentTime)
        		...
        		if(isCheckedCount == 0)
        			temp_left_time = 1*DAYSUMMUNTIME - (currentTime - tempTime);
        		else temp_left_time = 7*DAYSUMMUNTIME - (currentTime - tempTime);
        	}
        ...
        String sAgeFormat1 = mcontext.getResources().getString(R.string.dialog_setting_add_alarm);  
